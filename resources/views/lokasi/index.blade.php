                ...
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <div class="col-md-3 col-sm-3 col-xs-4 text-right">
                      <button class="btn btn-sm btn-primary" data-tooltip="tooltip" title="Tambah" data-toggle="modal"
                        data-target="#createLokasiModal">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              @endphp
                              <button type="button" class="btn btn-sm btn-info text-white edit-lokasi"
                                data-lokasi="{{ $dataLokasi }}" data-toggle="modal" data-target="#editLokasiModal"
                            ...
                            <div class="btn-group">
                              <form method="post" class="delete_form " data-tooltip="tooltip" title="Hapus"
                                action="{{route('lokasi.destroy',$l['id'])}}">
                                @method('DELETE')
                                @csrf
