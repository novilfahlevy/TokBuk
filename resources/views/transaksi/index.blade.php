                ...
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <div class="col-md-3 col-sm-3 col-xs-4 text-right d-flex align-items-center">
                      ...
                      <a href="{{ route('transaksi.create') }}" class="btn btn-sm btn-primary" data-tooltip="tooltip"
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group mb-0">
                  ...
                  <input type="date" class="form-control" id="mulaiFilter" name="mulai"
              ...
              <div class="col-6">
                <div class="form-group mb-0">
                  ...
                  <input type="date" class="form-control" id="sampaiFilter" name="sampai"
