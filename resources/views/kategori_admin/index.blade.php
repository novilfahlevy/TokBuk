              ...
              <div class="card-header">
                ...
                <div class="card-header-action">
                  <div class="col-md-3 col-sm-3 col-xs-4 text-right">
                    <a class="btn btn-sm btn-primary text-white" data-toggle="modal" data-target=".bs-example-modal-lg-"
                  ...
                  <table id="table-index" class="display table-striped table-bordered"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a type="submit" class="btn btn-sm btn-info text-white" data-toggle="modal"
                              data-target=".bs-example-modal-lg-{{$j->id}}"><i class="fas fa-pencil-alt"
                                data-tooltip="tooltip" title="Edit"></i></a>
                          </div>
                          <div class="btn-group">
                            <form method="post" class="delete_form " data-tooltip="tooltip" title="Hapus"
                              action="{{route('kategori.destroy',$j['id'])}}">
                              @method('DELETE')
                              @csrf
                        ...
                        {{-- modal edit --}}
                        <div class="modal fade bs-example-modal-lg-{{$j->id}}" id="exampleModal" tabindex="-1"
