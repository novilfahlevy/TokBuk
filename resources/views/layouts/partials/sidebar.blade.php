<div class="main-sidebar pb-5">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li
        class="dropdown{{ (Request::segment(1) === 'penulis' || Request::segment(1) === 'penerbit' || Request::segment(1) === 'kategori' || Request::segment(1) === 'distributor' || Request::segment(1) === 'lokasi') ? ' active' : '' }}">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-database"></i> <span>Data
            Master</span></a>
        <ul
          class="dropdown-menu{{ (Request::segment(1) === 'penulis' || Request::segment(1) === 'penerbit' || Request::segment(1) === 'kategori' || Request::segment(1) === 'distributor' || Request::segment(1) === 'lokasi') ? ' show' : '' }}">
