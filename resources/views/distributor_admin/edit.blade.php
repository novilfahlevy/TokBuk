              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="telepon" required name="telepon"
                      value="{{$distributor->telepon}}" min="0">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <textarea type="text" class="form-control" id="alamat" required name="alamat"
                      style="height:215px">{{$distributor->alamat}}</textarea>
                  </div>
                </div>
              </div>
