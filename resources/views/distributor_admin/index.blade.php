              ...
              <div class="card-header">
                ...
                <div class="card-header-action">
                  <div class="col-md-3 col-sm-3 col-xs-4 text-right">
                    <a class="btn btn-sm btn-primary" href="{{route('distributor.create')}}" data-tooltip="tooltip"
                ...
                <div class="table-responsive">
                  <table id="table-index" class="display table-striped table-bordered"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-sm btn-primary text-white" data-toggle="modal"
                            data-target=".bs-example-modal-lg-{{$s->id}}" data-tooltip="tooltip" title="Detail"><i
                              class="fa fa-info px-1"></i></a>
                          <div class="btn-group">
                            <a type="submit" class="btn btn-sm btn-info text-white"
                              href="{{ route('distributor.edit',  ['id' => $s["id"]]) }}" data-tooltip="tooltip"
                              title="Edit"><i class="fas fa-pencil-alt"></i></a>
                          </div>
                          <div class="btn-group">
                            <form method="post" class="delete_form " data-tooltip="tooltip" title="Hapus"
                              action="{{route('distributor.destroy',$s['id'])}}">
                              @method('DELETE')
                              @csrf
                      ...
                      <div class="modal fade bs-example-modal-lg-{{$s->id}}" id="exampleModal" tabindex="-1"
