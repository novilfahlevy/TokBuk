                  ...
                  <div class="card-header-action">
                    <div class="col-md-3 col-sm-3 col-xs-4 text-right d-flex align-items-center">
                      <button type="button" class="btn btn-sm btn-warning" data-toggle="modal"
                        data-target="#filterModal" data-tooltip="tooltip" title="Filter"><i
                          class="fas fa-filter"></i></button>
                      {{-- <a class="btn btn-sm btn-primary" href="{{route('buku.create')}}" data-tooltip="tooltip"
                          ...
                          <td>
                            <div class="btn-group">
                              <a href="{{ route( 'buku.detail' ,['id' => $b->id]) }}"
                                class="btn btn-sm btn-primary text-white" data-tooltip="tooltip" title="Detail"><i
                                  class="fa fa-info px-1"></i></i></a>
                            </div>
                            <div class="btn-group">
                              <a type="submit" class="btn btn-sm btn-info text-white"
                                href="{{ route('buku.edit',  ['id' => $b["id"]]) }}" data-tooltip="tooltip"
                            ...
                            {{-- <div class="btn-group">
                                        <a href="{{ route( 'buku.tambah' ,['id' => $b->id]) }}" class="btn btn-sm
                            btn-success text-white" title="Tambah Jumlah Buku"><i class="fas fa-plus"></i></i></a>
                  </div> --}}
                  </td>
                  </tr>
                  @endforeach
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="form-group mb-3">
                ...
                <input type="number" id="tahunTerbitDari" name="tahunTerbitDari" class="form-control" pattern="/0-9/"
                  value="{{ session()->pull('tahunTerbitDari') }}" min="0">
              </div>
            </div>
            <div class="col-6">
              <div class="form-group mb-3">
                <label for="tahunTerbitSampai">Tahun terbit sampai</label>
                <input type="number" id="tahunTerbitSampai" name="tahunTerbitSampai" class="form-control"
                  pattern="/0-9/" value="{{ session()->pull('tahunTerbitSampai') }}" min="0">
              </div>
            </div>
            <div class="col-6">
              <div class="form-group mb-3">
            ...
            <div class="col-12">
              <div class="form-group mt-2 mb-0">
                <div class="custom-control custom-checkbox" style="cursor: pointer;">
                  <input type="checkbox" class="custom-control-input" name="diskon" id="diskon"
                    {{ session()->pull('diskon') ? 'checked' : '' }}>
                  <label class="custom-control-label" for="diskon"
                    style="user-select: none; cursor: pointer;">Diskon</label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer d-flex justify-content-between pt-3">
          <a href="{{ route('buku') }}" class="btn btn-info">Bersihkan</a>
          <div>
