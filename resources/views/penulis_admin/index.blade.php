              ...
              <div class="card-header">
                ...
                <div class="card-header-action">
                  <div class="col-md-3 col-sm-3 col-xs-4 text-right">
                    <a class="btn btn-sm btn-primary text-white" data-target=".bs-example-modal-lg-" data-toggle="modal"
                      data-tooltip="tooltip" title="Tambah"><i class="fas fa-plus"></i></a>
                  </div>
                </div>
              </div>
                    ...
                    <form action="{{ route('penulis.store') }}" method="POST" enctype="multipart/form-data"
                      ...
                      <div class="modal-body pb-2">
                        ...
                        <div class="form-group mb-0">
                          ...
                          <input type="text" class="form-control" required id="recipient-name" name="nama"
                            value="{{ old('nama') }}">
                        </div>
                      </div>
                  ...
                  <table id="table-index" class="display table-striped table-bordered"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a type="submit" class="btn btn-sm btn-info text-white" data-toggle="modal"
                              data-target=".bs-example-modal-lg-{{$p->id}}" data-tooltip="tooltip" title="Edit"><i
                                class="fas fa-pencil-alt"></i></a>
                          </div>
                          <div class="btn-group">
                            <form method="post" class="delete_form " data-tooltip="tooltip" title="Hapus"
                              action="{{route('penulis.destroy',$p['id'])}}">
                              @method('DELETE')
                              @csrf
                              <button class="btn btn-sm btn-danger btn-delete" title="Hapus data"><i
